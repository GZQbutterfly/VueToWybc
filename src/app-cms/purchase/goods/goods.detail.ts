...
export class CmsPurchaseGoodsDetail extends BaseVue {
    ...
    goShopcart() {
        this.$router.push({ path: "cmsPurchaseShoppcar" });
    }
    joinCar(goodsId) {
    ...
    finishgoPay(num) {
        ...
        this.$router.push({ path: 'cmsPurchaseSubmitOrder', query: { goodsId: goodsId, goodsType: goodsType, number: num, orderSrouce: 'goods' } });
    }
    //倒计时
