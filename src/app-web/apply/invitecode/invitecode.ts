...
import { getLocalUserInfo, isNotLogin, toLogin, toCMS } from '../../../commons/common.env';
...
export class ApplyShopInvitecode extends BaseVue {
    ...
    dialogPopup(data) {
        ...
        _self._$popup({
            ...
            mainFn() {
                _self.$router.push({ path: 'applyShop', query: { incode: _self.incode } });
            }
        });
    }
                ...
                _self._$dialog({
                    dialogObj: {
                        ...
                        mainFn() {
                            ...
                            _self.$router.push({ path: 'applyShop', query: query });
                        }
                    }
                });
            }
    ...
    toWiki() {
        ...
        this.$router.push({ path: 'applyShopWiki', query: query });
    }
}
