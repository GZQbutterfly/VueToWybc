...
function getD(leftTime) {
    let d: any = Math.floor(leftTime / (24 * 60 * 60 * 1000));
...
function getH(leftTime) {
    let h: any = Math.floor(leftTime / (60 * 60 * 1000));
    let _h = h * 60 * 60 * 1000;
    h = h > 0 ? (h < 10 ? '0' + h : h) : '00';
...
function getM(leftTime) {
    let m: any = Math.floor((leftTime) / (60 * 1000));
    let _m = m * 60 * 1000;
    m = m > 0 ? (m < 10 ? '0' + m : m) : '00';
...
function getS(leftTime) {
    let s: any = Math.floor((leftTime) / 1000);
    s = s > 0 ? (s < 10 ? '0' + s : s) : '00';
    return { s };
}