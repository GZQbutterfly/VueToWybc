...
import { PayInterface } from './pay.inerface';
 ...
 * 支付宝支付类
 */
export class AliPay implements PayInterface {
    private _$vm;
    private _$store;
    private _$router;
    private _$state;
    ...
    // 手机支付打开支付宝
    private _webHost = 'https://openapi.alipay.com/gateway.do'; // https://mapi.alipay.com/gateway.do  https://openapi.alipay.com/gateway.do
    private _webDevHost = 'https://openapi.alipaydev.com/gateway.do';
    constructor(_vm) {
        this._$vm = _vm;
