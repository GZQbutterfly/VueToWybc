...
export default {
    install: function (Vue, options) {
        ...
        _win.LOGIC_EVENT_BUS = LOGIC_EVENT_BUS;

        Vue.component('lg-preview', PicturePreview);
        ...
        Vue.directive('preview', {
            bind: function (el) {
                let previewItem = {
                    ...
                    el: el,
                    index: 0,
                    src: el.src || 'data:img/jpg;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEXs7Oxc9QatAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg=='
                }
                ...
                el.addEventListener('click', (e) => {
                    ...
                    LOGIC_EVENT_BUS.LOGIC_PREVIEW.currentIndex = _target.getAttribute('data-index');
                    // previewItem.src
                    getImage(_target.src, previewItem);
                })
            },
